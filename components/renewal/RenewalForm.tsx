        ...
        {win && (
          <div className="rounded-2xl border border-brand-200 bg-brand-50 p-6 shadow-sm">
            ...
            <ul className="mt-4 space-y-2 text-xs leading-relaxed text-slate-600">
              ...
              <li>
                · 위 날짜는 입력하신 만료일을 법령의 기간 계산 방식(민법 제157조, 제160조의
                유추적용)에 기계적으로 대입한 결과이며, 개별 사안에 대한 법률적 판단이 아닙니다.
                기간 계산 방식에는 견해 차이가 있어, 본 서비스는 더 이른 마감 시점을 기준으로
                표시합니다.
              </li>
              <li>
                · 우편은 도달까지 시일이 걸립니다. 마감보다 여유를 두고 발송하는 것이 일반적입니다.
              </li>
